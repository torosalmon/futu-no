                      ...
                      <li>
                        <a class="prev" href="<?= get_permalink($prev_post->ID); ?>">
                          <?php if (has_post_thumbnail($prev_post->ID)): ?>
                            ...
                            <img src="<?= $thumnbnail_320px_url[0]; ?>" alt="<?= esc_attr($prev_post->post_title); ?>" loading="lazy">
                          <?php endif; ?>
                      ...
                      <li>
                        <a class="next" href="<?= get_permalink($next_post->ID); ?>">
                          <?php if (has_post_thumbnail($next_post->ID)): ?>
                            ...
                            <img src="<?= $thumnbnail_320px_url[0]; ?>" alt="<?= esc_attr($next_post->post_title); ?>" loading="lazy">
                          <?php endif; ?>
